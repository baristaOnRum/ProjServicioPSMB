 ...
 * @author Cesar
 */
public class busqueda_obrero extends javax.swing.JFrame {

    /**
     * Creates new form BusquedaEstudianteSimulada
     */
    public busqueda_obrero() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton2.setText("Añadir personal");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Cédula", "Nombre", "Apellido", "Estado Civil", "Estatus", "Género", "Grado de Estudios", "Ocupación", "Comunidad de residencia", "Parroquia de residencia", "Municipio de residencia", "Ninguno" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(busqueda_obrero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new busqueda_obrero().setVisible(true);
            }
        });
    }
