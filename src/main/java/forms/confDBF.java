 ...
 * @author Sebastian
 */
public class confDBF extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(confDBF.class.getName());

    /**
     * Creates new form confDB
     */
    public confDBF(acceso acceso, menuPrincipal main) {
        initComponents();
        accesoChild = acceso;
        menuMain = main;
    }
