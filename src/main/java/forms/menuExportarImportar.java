 ...
 * @author Uzer
 */
public class menuExportarImportar extends javax.swing.JFrame {

    /**
     * Creates new form menuExportarImportar
     */
    public menuExportarImportar() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(menuExportarImportar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new menuExportarImportar().setVisible(true);
            }
        });
    }
