 ...
 * @author Cesar
 */
public class busqueda_autorizado extends javax.swing.JFrame {

    /**
     * Creates new form BusquedaEstudianteSimulada
     */
    public busqueda_autorizado() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "C.I Autorizado", "C.I Representante", "C.I Estudiante" }));
        ...
        jLabel1.setText("AUTORIZADO PARA RETIRO");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(busqueda_autorizado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new busqueda_autorizado().setVisible(true);
            }
        });
    }
